...
ls ./jar/jcustenborder-kafka-connect-spooldir/lib/kafka-connect-spooldir-*.jar || confluent-hub install  --component-dir ./jar jcustenborder/kafka-connect-spooldir:latest --no-prompt
echo "Done"
