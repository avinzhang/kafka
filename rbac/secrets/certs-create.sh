...
for i in zookeeper zookeeper1 zookeeper2 kafka kafka1 kafka2 client schemaregistry restproxy connect connect1 ksqldb-server ksqldb-server1 controlcenter openldap
do
	echo "------------------------------- $i -------------------------------"
