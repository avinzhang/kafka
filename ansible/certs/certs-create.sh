...
for i in zookeeper1.example.com zookeeper2.example.com zookeeper3.example.com kafka1.example.com kafka2.example.com kafka3.example.com connect1.example.com connect2.example.com schemaregistry.example.com kafkarest.example.com ksqldb.example.com controlcenter.example.com openldap.example.com
do
	echo "------------------------------- $i -------------------------------"
