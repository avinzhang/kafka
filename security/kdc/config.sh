...
create_principals() {
  ...
  kadmin.local -q "ktadd -norandkey -k /tmp/keytab/zookeeper.keytab zookeeper/zookeeper.example.com@EXAMPLE.COM"
  ...
  kadmin.local -q "ktadd -norandkey -k /tmp/keytab/kafka.keytab kafka/kafka.example.com@EXAMPLE.COM"
