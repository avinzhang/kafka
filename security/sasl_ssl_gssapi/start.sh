...
docker-compose -f docker-compose.yml -f ./security/sasl_ssl_gssapi/docker-compose-sasl-ssl-gssapi.yml up -d --build --no-deps kerberos zookeeper kafka schemaregistry
...
echo "Done"
echo
docker-compose -f docker-compose.yml -f ./security/sasl_ssl_gssapi/docker-compose-sasl-ssl-gssapi.yml up -d --build --no-deps connect
echo
connect_ready=false
...
docker-compose -f docker-compose.yml -f ./security/sasl_ssl_gssapi/docker-compose-sasl-ssl-gssapi.yml up -d --build --no-deps controlcenter
